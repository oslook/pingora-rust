...
[pingora-proxy/examples/load_balancer.rs](https://github.com/cloudflare/pingora/pingora-proxy/examples/load_balancer.rs)

Other examples that you may find helpful are also available here

[pingora-proxy/examples/](https://github.com/cloudflare/pingora/pingora-proxy/examples/)
[pingora/examples](https://github.com/cloudflare/pingora/pingora/examples/)