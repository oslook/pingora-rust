...
The complete example can be found under [`pingora-proxy/examples/ctx.rs`](https://github.common/cloudflare/pingora/tree/main/pingora-proxy/examples/ctx.rs). You can run it using `cargo`:
```
