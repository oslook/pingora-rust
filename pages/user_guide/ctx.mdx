...
The complete example can be found under [`pingora-proxy/examples/ctx.rs`](https://github.com/cloudflare/pingora/tree/main/pingora-proxy/examples/ctx.rs). You can run it using `cargo`:
```
